...
# Data parameters
tf.flags.DEFINE_string('data_file', './data/植发_intention_0520.xlsx', 'Data file path')
...
tf.flags.DEFINE_integer('num_classes', 15, 'Number of classes')
...
tf.flags.DEFINE_float('decay_rate', 0.7, 'Learning rate decay rate. Range: (0, 1]')  # Learning rate decay
...
# Load and save data
# =============================================================================
data, labels, lengths,label_dict, vocab_processor = data_helper.load_data(file_path=FLAGS.data_file,
